...
class TemperatureMachine(StateMachine):
    ...
    def updateLights(self):
        ...
        # Compare current temperature to setPoint, if desired temperature is reached, set LED to solid. Otherwise, set LED to pulse.
    ...
    def setupSerialOutput(self):
        ...
        output = f"{tsm.current_state.id},{self.getFahrenheit()},{self.setPoint}"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                # Create LCD Line #2, displaying current temperature in Fahrenheit
                lcd_line_2 = f"T: {self.getFahrenheit():0.1f}F"
    
                altCounter = altCounter + 1
            else:

                # Create LCD Line #2, displaying current state and current setpoint in Fahrenheit
                lcd_line_2 = f"ST: {tsm.current_state.id} SP: {tsm.setPoint}"
            ...
            if((counter % 30) == 0):
                ...
                # Send state information to TemperatureServer
...
# Define Green Button Behavior, change states.
...
# Define Red Button Behavior, increment.
...
# Define Blue Button Behavior, decrement.
